...
public class QVPSampleADVideoPlayer extends ListQVPVideoPlayer {
    ...
    public QVPSampleADVideoPlayer(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }

    public QVPSampleADVideoPlayer(Context context) {
        super(context);
    }

    public QVPSampleADVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected boolean setUp(List<QVPVideoModel> url, boolean cacheWithPlay, int position, File cachePath, Map<String, String> mapHeadData, boolean changeState) {
        ...
        if (QVPVideoModel instanceof GSYADVideoModel) {
            GSYADVideoModel gsyadVideoModel = (GSYADVideoModel) QVPVideoModel;
    ...
    protected void cloneParams(QVPBaseVideoPlayer from, QVPBaseVideoPlayer to) {
        ...
        QVPSampleADVideoPlayer sf = (QVPSampleADVideoPlayer) from;
        QVPSampleADVideoPlayer st = (QVPSampleADVideoPlayer) to;
    ...
    public boolean setAdUp(ArrayList<GSYADVideoModel> url, boolean cacheWithPlay, int position) {
        return setUp((ArrayList<QVPVideoModel>) url.clone(), cacheWithPlay, position);
    }
    ...
    public boolean setAdUp(ArrayList<GSYADVideoModel> url, boolean cacheWithPlay, int position, File cachePath) {
        return setUp((ArrayList<QVPVideoModel>) url.clone(), cacheWithPlay, position, cachePath);
    }
    ...
    public boolean setAdUp(ArrayList<GSYADVideoModel> url, boolean cacheWithPlay, int position, File cachePath, Map<String, String> mapHeadData) {
        return setUp((ArrayList<QVPVideoModel>) url.clone(), cacheWithPlay, position, cachePath, mapHeadData);
    }

    public static class GSYADVideoModel extends QVPVideoModel {
        /**
         * 正常
         */
