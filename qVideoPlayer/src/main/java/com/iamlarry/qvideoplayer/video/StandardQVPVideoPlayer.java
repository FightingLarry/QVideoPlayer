...
import com.iamlarry.qvideoplayer.utils.NetworkUtils;
...
import com.iamlarry.qvideoplayer.view.ui.ENPlayView;
...
public class StandardQVPVideoPlayer extends QVPVideoPlayer {
     ...
     */
    public StandardQVPVideoPlayer(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }

    public StandardQVPVideoPlayer(Context context) {
        super(context);
    }

    public StandardQVPVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void startPlayLogic() {
        if (mIVideoAllCallBack != null) {
            ...
            mIVideoAllCallBack.onClickStartThumb(mOriginUrl, mTitle, StandardQVPVideoPlayer.this);
        }
        prepareVideo();
    ...
    protected void cloneParams(QVPBaseVideoPlayer from, QVPBaseVideoPlayer to) {
        ...
        StandardQVPVideoPlayer sf = (StandardQVPVideoPlayer) from;
        StandardQVPVideoPlayer st = (StandardQVPVideoPlayer) to;
    ...
    public QVPBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            StandardQVPVideoPlayer gsyVideoPlayer = (StandardQVPVideoPlayer) gsyBaseVideoPlayer;
     ...
     * 全屏的UI逻辑
     */
    private void initFullUI(StandardQVPVideoPlayer standardGSYVideoPlayer) {
     ...
     * @param high 是否需要高清的
     */
    public void taskShotPic(IQVPVideoShotListener IQVPVideoShotListener, boolean high) {
        if (getCurrentPlayer().getRenderProxy() != null) {
            getCurrentPlayer().getRenderProxy().taskShotPic(IQVPVideoShotListener, high);
        }
    }
    ...
    public void saveFrame(final File file, final boolean high, final IQVPVideoShotSaveListener IQVPVideoShotSaveListener) {
        if (getCurrentPlayer().getRenderProxy() != null) {
            getCurrentPlayer().getRenderProxy().saveFrame(file, high, IQVPVideoShotSaveListener);
        }
    }
