package com.iamlarry.qvideoplayer.utils;
...
public class GSYVideoHelper {
     ...
     * 播放器
     */
    private StandardQVPVideoPlayer mGsyVideoPlayer;
    /**
     * 全屏承载布局
     */
     ...
     * 播放配置
     */
    private QVPVideoHelperBuilder mVideoOptionBuilder;
    /**
     * 上下文
     */
    ...
    public GSYVideoHelper(Context context) {
        this(context, new StandardQVPVideoPlayer(context));
    }

    public GSYVideoHelper(Context context, StandardQVPVideoPlayer player) {
     ...
     */
    private void resolveMaterialFullVideoShow(QVPBaseVideoPlayer gsyVideoPlayer) {
     ...
     * 动画回到正常效果
     */
    private void resolveMaterialToNormal(final QVPVideoPlayer gsyVideoPlayer) {
    ...
    public void showSmallVideo(Point size, final boolean actionBar, final boolean statusBar) {
        if (mGsyVideoPlayer.getCurrentState() == QVPVideoPlayer.CURRENT_STATE_PLAYING) {
     ...
     * 设置配置
     */
    public void setGsyVideoOptionBuilder(QVPVideoHelperBuilder mVideoOptionBuilder) {
        this.mVideoOptionBuilder = mVideoOptionBuilder;
    }

    public QVPVideoOptionBuilder getGsyVideoOptionBuilder() {
     ...
     */
    public StandardQVPVideoPlayer getGsyVideoPlayer() {
     ...
     * 配置
     */
    public static class QVPVideoHelperBuilder extends QVPVideoOptionBuilder {
        ...
        public QVPVideoHelperBuilder setHideActionBar(boolean hideActionBar) {
        ...
        public QVPVideoHelperBuilder setHideStatusBar(boolean hideStatusBar) {
        ...
        public IVideoAllCallBack getVideoAllCallBack() {
            return mIVideoAllCallBack;
        }

        public ILockClickListener getLockClickListener() {
            return mILockClickListener;
        }
        ...
        public IQVPVideoProgressListener getGSYVideoProgressListener() {
            return mIQVPVideoProgressListener;
        }
    }
