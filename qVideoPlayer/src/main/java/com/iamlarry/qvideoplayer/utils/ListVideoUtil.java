...
public class ListVideoUtil {
    ...
    private StandardQVPVideoPlayer gsyVideoPlayer;
    ...
    private IVideoAllCallBack IVideoAllCallBack;
    private String url;
    ...
    public ListVideoUtil(Context context) {
        gsyVideoPlayer = new StandardQVPVideoPlayer(context);
    ...
    private void resolveToNormal() {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                gsyVideoPlayer.getBackButton().setVisibility(View.GONE);
                gsyVideoPlayer.setIfCurrentIsFullscreen(false);
                if (IVideoAllCallBack != null) {
                    Debuger.printfLog("onQuitFullscreen");
                    IVideoAllCallBack.onQuitFullscreen(url, mTitle, gsyVideoPlayer);
                }
                if (hideKey) {
    ...
    private void resolveChangeFirstLogic(int time) {
        ...
        if (IVideoAllCallBack != null) {
            ...
            IVideoAllCallBack.onEnterFullscreen(this.url, mTitle, gsyVideoPlayer);
        }
    }
    ...
    public void showSmallVideo(Point size, final boolean actionBar, final boolean statusBar) {
        if (gsyVideoPlayer.getCurrentState() == QVPVideoPlayer.CURRENT_STATE_PLAYING) {
     ...
     * 视频接口回调
     *
     * @param IVideoAllCallBack 回调
     */
    public void setVideoAllCallBack(IVideoAllCallBack IVideoAllCallBack) {
        this.IVideoAllCallBack = IVideoAllCallBack;
        gsyVideoPlayer.setVideoAllCallBack(IVideoAllCallBack);
    }
