...
import com.iamlarry.qvideoplayer.render.QVPRenderView;
import com.iamlarry.qvideoplayer.render.IQVPSurfaceListener;
...
public abstract class QVPTextureRenderView extends FrameLayout implements IQVPSurfaceListener, MeasureHelper.MeasureFormVideoParamsListener {

    //native绘制
    protected Surface mSurface;

    //渲染控件
    protected QVPRenderView mTextureView;
...
//    protected int mMode = GSYVideoGLView.MODE_LAYOUT_SIZE;
    ...
    public QVPTextureRenderView(@NonNull Context context) {
        super(context);
    }

    public QVPTextureRenderView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public QVPTextureRenderView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    protected void addTextureView() {
        mTextureView = new QVPRenderView();
     ...
     * 获取渲染的代理层
     */
    public QVPRenderView getRenderProxy() {
        return mTextureView;
    }
