...
import com.iamlarry.qvideoplayer.utils.NetInfoModule;
...
import static com.iamlarry.qvideoplayer.utils.CommonUtil.getTextSpeed;
...
public abstract class QVPVideoView extends QVPTextureRenderView implements IQVPMediaPlayerListener {
    ...
    public QVPVideoView(@NonNull Context context) {
        super(context);
        init(context);
    }

    public QVPVideoView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public QVPVideoView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public QVPVideoView(Context context, Boolean fullFlag) {
        super(context);
    ...
    protected void startButtonLogic() {
        if (mIVideoAllCallBack != null && mCurrentState == CURRENT_STATE_NORMAL) {
            Debuger.printfLog("onClickStartIcon");
            mIVideoAllCallBack.onClickStartIcon(mOriginUrl, mTitle, this);
        } else if (mIVideoAllCallBack != null) {
    ...
    protected void startPrepare() {
        ...
        if (mIVideoAllCallBack != null) {
            ...
            mIVideoAllCallBack.onStartPrepared(mOriginUrl, mTitle, this);
        }
    ...
    public void onPrepared() {
        ...
        if (mIVideoAllCallBack != null && isCurrentMediaListener()) {
            ...
            mIVideoAllCallBack.onPrepared(mOriginUrl, mTitle, this);
        }
    ...
    public void onAutoCompletion() {
        ...
        if (mIVideoAllCallBack != null && isCurrentMediaListener()) {
            ...
            mIVideoAllCallBack.onAutoComplete(mOriginUrl, mTitle, this);
        }
    }
    ...
    public void onError(int what, int extra) {
        ...
        if (mNetChanged) {
            ...
            netWorkErrorLogic();
            if (mIVideoAllCallBack != null) {
                mIVideoAllCallBack.onPlayError(mOriginUrl, mTitle, this);
            }
            return;
        }
     ...
     * 获取管理器桥接的实现
     */
    public abstract IQVPVideoViewBridge getGSYVideoManager();
     ...
     */
    public void setVideoAllCallBack(IVideoAllCallBack mIVideoAllCallBack) {
