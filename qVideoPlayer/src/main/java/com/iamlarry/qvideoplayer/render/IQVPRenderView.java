...
public interface IQVPRenderView {

    IQVPSurfaceListener getIGSYSurfaceListener();

    /**
     * Surface变化监听，必须
     */
    void setIGSYSurfaceListener(IQVPSurfaceListener surfaceListener);
     ...
     * 截图
     */
    void taskShotPic(IQVPVideoShotListener IQVPVideoShotListener, boolean shotHigh);

    /**
     * 保存当前帧
     */
    void saveFrame(final File file, final boolean high, final IQVPVideoShotSaveListener IQVPVideoShotSaveListener);
