package com.iamlarry.qvideoplayer.builder;

import android.graphics.drawable.Drawable;
import android.view.View;

import com.iamlarry.qvideoplayer.listener.IQVPVideoProgressListener;
import com.iamlarry.qvideoplayer.listener.ILockClickListener;
import com.iamlarry.qvideoplayer.listener.IVideoAllCallBack;
import com.iamlarry.qvideoplayer.video.StandardQVPVideoPlayer;
...
public class QVPVideoOptionBuilder {
    ...
    //视频状体回调
    protected IVideoAllCallBack mIVideoAllCallBack;

    //点击锁屏的回调
    protected ILockClickListener mILockClickListener;
    ...
    //进度回调
    protected IQVPVideoProgressListener mIQVPVideoProgressListener;
     ...
     */
    public QVPVideoOptionBuilder setShowFullAnimation(boolean showFullAnimation) {
     ...
     * 设置循环
     */
    public QVPVideoOptionBuilder setLooping(boolean looping) {
     ...
     * 设置播放过程中的回调
     *
     * @param mIVideoAllCallBack
     */
    public QVPVideoOptionBuilder setVideoAllCallBack(IVideoAllCallBack mIVideoAllCallBack) {
        this.mIVideoAllCallBack = mIVideoAllCallBack;
        return this;
    }
     ...
     * 是否开启自动旋转
     */
    public QVPVideoOptionBuilder setRotateViewAuto(boolean rotateViewAuto) {
     ...
     */
    public QVPVideoOptionBuilder setLockLand(boolean lockLand) {
     ...
     * 播放速度
     */
    public QVPVideoOptionBuilder setSpeed(float speed) {
        this.mSpeed = speed;
        return this;
    }
     ...
     * 变声不变调
     */
    public QVPVideoOptionBuilder setSoundTouch(boolean soundTouch) {
     ...
     * 全屏隐藏虚拟按键，默认打开
     */
    public QVPVideoOptionBuilder setHideKey(boolean hideKey) {
     ...
     * 默认true
     */
    public QVPVideoOptionBuilder setIsTouchWiget(boolean isTouchWiget) {
     ...
     * 默认 true
     */
    public QVPVideoOptionBuilder setIsTouchWigetFull(boolean isTouchWigetFull) {
     ...
     * 是否需要显示流量提示,默认true
     */
    public QVPVideoOptionBuilder setNeedShowWifiTip(boolean needShowWifiTip) {
     ...
     * 不设置使用默认
     */
    public QVPVideoOptionBuilder setEnlargeImageRes(int mEnlargeImageRes) {
     ...
     * 不设置使用默认
     */
    public QVPVideoOptionBuilder setShrinkImageRes(int mShrinkImageRes) {
     ...
     */
    public QVPVideoOptionBuilder setShowPauseCover(boolean showPauseCover) {
     ...
     */
    public QVPVideoOptionBuilder setSeekRatio(float seekRatio) {
        if (seekRatio < 0) {
            return this;
        }
     ...
     */
    public QVPVideoOptionBuilder setRotateWithSystem(boolean rotateWithSystem) {
     ...
     */
    public QVPVideoOptionBuilder setPlayTag(String playTag) {
     ...
     * 设置播放位置防止错位
     */
    public QVPVideoOptionBuilder setPlayPosition(int playPosition) {
     ...
     */
    public QVPVideoOptionBuilder setSeekOnStart(long seekOnStart) {
     ...
     * @param url
     */
    public QVPVideoOptionBuilder setUrl(String url) {
        this.mUrl = url;
        return this;
    }
     ...
     * @param videoTitle
     */
    public QVPVideoOptionBuilder setVideoTitle(String videoTitle) {
     ...
     * @param cacheWithPlay
     */
    public QVPVideoOptionBuilder setCacheWithPlay(boolean cacheWithPlay) {
     ...
     */
    public QVPVideoOptionBuilder setStartAfterPrepared(boolean startAfterPrepared) {
     ...
     */
    public QVPVideoOptionBuilder setReleaseWhenLossAudio(boolean releaseWhenLossAudio) {
     ...
     * @param cachePath
     */
    public QVPVideoOptionBuilder setCachePath(File cachePath) {
     ...
     * @param mapHeadData
     */
    public QVPVideoOptionBuilder setMapHeadData(Map<String, String> mapHeadData) {
     ...
     * 进度回调
     */
    public QVPVideoOptionBuilder setGSYVideoProgressListener(IQVPVideoProgressListener videoProgressListener) {
        this.mIQVPVideoProgressListener = videoProgressListener;
        return this;
    }
     ...
     * 设置封面
     */
    public QVPVideoOptionBuilder setThumbImageView(View view) {
     ...
     * 底部进度条-弹出的
     */
    public QVPVideoOptionBuilder setBottomShowProgressBarDrawable(Drawable drawable, Drawable thumb) {
     ...
     * 底部进度条-非弹出
     */
    public QVPVideoOptionBuilder setBottomProgressBarDrawable(Drawable drawable) {
     ...
     * 声音进度条
     */
    public QVPVideoOptionBuilder setDialogVolumeProgressBar(Drawable drawable) {
     ...
     * 中间进度条
     */
    public QVPVideoOptionBuilder setDialogProgressBar(Drawable drawable) {
     ...
     * 中间进度条字体颜色
     */
    public QVPVideoOptionBuilder setDialogProgressColor(int highLightColor, int normalColor) {
     ...
     * 是否点击封面可以播放
     */
    public QVPVideoOptionBuilder setThumbPlay(boolean thumbPlay) {
     ...
     */
    public QVPVideoOptionBuilder setNeedLockFull(boolean needLoadFull) {
     ...
     * 锁屏点击
     */
    public QVPVideoOptionBuilder setLockClickListener(ILockClickListener ILockClickListener) {
        this.mILockClickListener = ILockClickListener;
        return this;
    }
     ...
     */
    public QVPVideoOptionBuilder setDismissControlTime(int dismissControlTime) {
     ...
     * 在播放前才真正执行setup
     */
    public QVPVideoOptionBuilder setSetUpLazy(boolean setUpLazy) {
        this.mSetUpLazy = setUpLazy;
        return this;
    }

    public QVPVideoOptionBuilder setFullHideActionBar(boolean actionBar) {
        this.mActionBar = actionBar;
        return this;
    }

    public QVPVideoOptionBuilder setFullHideStatusBar(boolean statusBar) {
        this.mStatusBar = statusBar;
        return this;
    }

    public void build(StandardQVPVideoPlayer gsyVideoPlayer) {
        ...
        build((QVPBaseVideoPlayer) gsyVideoPlayer);
    }

    public void build(QVPBaseVideoPlayer gsyVideoPlayer) {
        ...
        if (mILockClickListener != null) {
            gsyVideoPlayer.setLockClickListener(mILockClickListener);
        }
        ...
        if (mIVideoAllCallBack != null) {
            gsyVideoPlayer.setVideoAllCallBack(mIVideoAllCallBack);
        }
        if (mIQVPVideoProgressListener != null) {
            gsyVideoPlayer.setGSYVideoProgressListener(mIQVPVideoProgressListener);
        }
