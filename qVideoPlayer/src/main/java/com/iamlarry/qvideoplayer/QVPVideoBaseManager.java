...
import com.iamlarry.qvideoplayer.player.IJKPlayerManager;
import com.iamlarry.qvideoplayer.player.IPlayerManager;
import com.iamlarry.qvideoplayer.player.SystemPlayerManager;
...
public abstract class QVPVideoBaseManager implements IMediaPlayer.OnPreparedListener, IMediaPlayer.OnCompletionListener,
        IMediaPlayer.OnBufferingUpdateListener, IMediaPlayer.OnSeekCompleteListener, IMediaPlayer.OnErrorListener,
        IMediaPlayer.OnVideoSizeChangedListener, IMediaPlayer.OnInfoListener, IQVPVideoViewBridge {

    public static String TAG = "QVPVideoBaseManager";
    ...
    protected WeakReference<IQVPMediaPlayerListener> listener;

    protected WeakReference<IQVPMediaPlayerListener> lastListener;
    ...
    @Override
    public IQVPMediaPlayerListener listener() {
        if (listener == null)
            return null;
        return listener.get();
    }
    ...
    @Override
    public IQVPMediaPlayerListener lastListener() {
    ...
    @Override
    public void setListener(IQVPMediaPlayerListener listener) {
        if (listener == null)
            this.listener = null;
        else
    ...
    @Override
    public void setLastListener(IQVPMediaPlayerListener lastListener) {
        if (lastListener == null)
    ...
    public void prepare(final String url, final Map<String, String> mapHeadData, boolean loop, float speed) {
        ...
        QVPModel fb = new QVPModel(url, mapHeadData, loop, speed);
        msg.obj = fb;
