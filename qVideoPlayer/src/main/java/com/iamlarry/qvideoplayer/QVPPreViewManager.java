 ...
 */
@Deprecated
public class QVPPreViewManager implements IMediaPlayer.OnPreparedListener, IjkMediaPlayer.OnSeekCompleteListener {

    public static String TAG = "QVPPreViewManager";

    private static QVPPreViewManager videoManager;
    ...
    public static synchronized QVPPreViewManager instance() {
        if (videoManager == null) {
            videoManager = new QVPPreViewManager();
        }
        return videoManager;
    }

    private QVPPreViewManager() {
        IjkLibLoader libLoader = QVPVideoManager.getIjkLibLoader();
    ...
    private void initVideo(Message msg) {
        try {
            ...
            mediaPlayer.setOnPreparedListener(QVPPreViewManager.this);
    ...
    private void initIJKPlayer(Message msg) {
        ...
        try {
            mediaPlayer.setDataSource(((QVPModel) msg.obj).getUrl(), ((QVPModel) msg.obj).getMapHeadData());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
