 ...
 * 详情模式播放页面基础类
 */
public abstract class QVPBaseActivityDetail<T extends QVPBaseVideoPlayer> extends AppCompatActivity implements IVideoAllCallBack {
    ...
    public void showFull() {
        ...
        getGSYVideoPlayer().startWindowFullscreen(QVPBaseActivityDetail.this, hideActionBarWhenFull(), hideStatusBarWhenFull());
    ...
    public void onBackPressed() {
        ...
        if (QVPVideoManager.backFromWindowFull(this)) {
            return;
        }
        super.onBackPressed();
    }
     ...
     * 配置播放器
     */
    public abstract QVPVideoOptionBuilder getGSYVideoOptionBuilder();
